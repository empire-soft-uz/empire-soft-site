      ...
      <Image
        ...
        src={
          projects[index].promoBackground
            ? "/assets/ES_NEW/assets/" + projects[index].promoBackground
            : "/assets/1 401.svg"
        }
        fill
      ...
      <main className={styles.content}>
        <div className={styles.top}>
          <div data-aos="fade-up" data-aos-delay="0" className={styles.topLeft}>
            ...
            <Image
              src={
                "/assets/ES_NEW/assets/" + projects[index].logo ??
          ...
          {projects.map((item, _index) => {
            return (
              ...
              >
                ...
                {index == _index && <span className={styles.active}></span>}
                <Image
                  src={
                  ...
                  width={90}
                  height={30}
                  style={{ opacity: index == _index ? 1 : 0.4 }}
                />
              </div>
            );
          })}
